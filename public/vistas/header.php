...
<div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="index.php?controller=ProductosController&action=verCarrito" class="nav-link">🛒</a></li>
        
        <?php if(isset($_SESSION['usuario'])): ?>
          <li class="nav-item"><a href="index.php?controller=ProductosController&action=logout" class="nav-link active">Cerrar sesión</a></li>
          <li class="nav-item"><span class="nav-link"><?php echo $_SESSION['usuario']; ?></span></li>
        <?php else: ?>
          <li class="nav-item"><a href="index.php?controller=ProductosController&action=login" class="nav-link active">Iniciar sesión</a></li>
        <?php endif; ?>
